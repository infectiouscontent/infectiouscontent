<section id="section-sponsors">
	<div class="container-fluid sponsors">
		...
		<div class="row"><div class="col-xs-10 col-xs-offset-1"><div class="row">
			<div class="col-xs-3"> 
				<img src="https://s3.ap-northeast-2.amazonaws.com/international-vaccine-institute/swede-smalllogo-495x495px.png">
			</div>
			<div class="col-xs-3"> 	
